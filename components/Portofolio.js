    ...
    return(
        ...
        <div className="md:flex md:justify-center md:items-center">
            ...
            <div className="md:text-lg leading-relaxed mt-8 md:mt-0" data-aos="fade-up">
                <p className="md:mt-4 inline-block bg-gray-100 dark:bg-gray-200  rounded-lg font-bold py-1 px-2 mb-4 text-sm md:text-lg">Lorem Ipsum Dolor</p>
                ...
                <a href="https://github.com/yayakyogi" target="_blank" className="inline-block text-xs bg-gray-100 dark:bg-gray-200  rounded-lg font-semibold py-1 px-2 mb-4 md:text-lg hover:text-gray-700 focus:bg-gray-300">Check this out!</a>
            </div>
        </div>
    </div>
    )
